...
CREATE TABLE AREA (
	...
	PRIMARY KEY (Sigla),
	UNIQUE (Nome),
	FOREIGN KEY (SuperArea) REFERENCES AREA(Sigla) ON DELETE SET NULL
);
...
CREATE TABLE CURSO (
	...
	Area CHAR(5),
	PRIMARY KEY(Sigla),
	FOREIGN KEY (Area) REFERENCES AREA(Sigla) ON DELETE SET NULL,
	UNIQUE(Nome)
);
...
CREATE TABLE PROFESSOR (
	...
	PRIMARY KEY (CPF),
	FOREIGN KEY (Curso) REFERENCES CURSO(Sigla) ON DELETE CASCADE
);
...
CREATE TABLE TOPICO (
	...
	FOREIGN KEY (Modulo) REFERENCES MODULO(Sigla) ON DELETE CASCADE,
	UNIQUE (Nome)
);
...
CREATE TABLE MATRICULA (
	Curso CHAR(5),
   	Aluno CHAR(11),
        ...
        FOREIGN KEY (Curso) REFERENCES CURSO(Sigla) ON DELETE RESTRICT,
   	FOREIGN KEY (Aluno) REFERENCES ALUNO(CPF) ON DELETE RESTRICT
);
```